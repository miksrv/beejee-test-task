...
class Paginator
{
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li class="page-item"><a href="' . htmlspecialchars($this->getPrevUrl()) . '" class="page-link" title="">&laquo; '. $this->previousText .'</a></li>';
        }

        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li class="page-item' . ($page['isCurrent'] ? ' active' : '') . '"><a href="' . htmlspecialchars($page['url']) . '" title="" class="page-link">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
        ...
        if ($this->getNextUrl()) {
            $html .= '<li class="page-item"><a href="' . htmlspecialchars($this->getNextUrl()) . '" class="page-link" title="">'. $this->nextText .' &raquo;</a></li>';
        }
        $html .= '</ul>';
